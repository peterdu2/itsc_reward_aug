...
failures_list = pickle.load(open( 'multi_car_random_sample_data/random_sample.pkl', "rb" ))[0]
...
for i in range(top_k):
    ...
    action_list = failures_list[i]
    
    car_x = [sim._car[2]]
    car_y = [sim._car[3]]
    car2_x = [sim._car2[2]]
    car2_y = [sim._car2[3]]
    ped1_x = [sim._peds[0][2]]
    ped1_y = [sim._peds[0][3]]
    ped2_x = [sim._peds[1][2]]
    ped2_y = [sim._peds[1][3]]

    for action in action_list:
        sim.step(action)
        car_x.append(sim._car[2])
        car_y.append(sim._car[3])
        car2_x.append(sim._car2[2])
        car2_y.append(sim._car2[3])
        ped1_x.append(sim._peds[0][2])
        ped1_y.append(sim._peds[0][3])
        ped2_x.append(sim._peds[1][2])
        ped2_y.append(sim._peds[1][3])
    ...
    for frame in range(len(car_x)):
        ...
        filepath = 'animations/random_sample/T'+str(i)+'/'+str(frame)+'.jpeg'
