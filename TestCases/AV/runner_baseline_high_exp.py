...
sim = multi_car_simulator(num_peds=2,use_seed=False,spaces=spaces, max_path_length=max_path_length, car_init_x=-20, v_des=11.1, min_dist_x=0.5, min_dist_y=0.5, car_init_x2=-37, v_des2=12.5, ped_initial_states=pedestrian_init_state)
...
#Initial MCTS run
result, initial_trajectories = AST_MCTS.stress_test_multi(ast, top_k, 85000, max_path_length, 0.0)


filename = 'high_exp/high_exp.pkl'
