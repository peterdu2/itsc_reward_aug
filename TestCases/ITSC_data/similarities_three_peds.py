...
print("NORMALISED AVERAGE: ", total/(num_peds*num_paths), file=open('three_peds/t1_no_discount/similarities.txt', 'a'))
...
print("NORMALISED AVERAGE: ", total/(num_peds*num_paths), file=open('three_peds/t1_w_discount/traj_050_state_0/similarities.txt', 'a'))
...
print("NORMALISED AVERAGE: ", total/(num_peds*num_paths), file=open('three_peds/t1_w_discount/traj_100_state_0/similarities.txt', 'a'))
...
print("NORMALISED AVERAGE: ", total/(num_peds*num_paths), file=open('three_peds/t1_w_discount/traj_150_state_0/similarities.txt', 'a'))
