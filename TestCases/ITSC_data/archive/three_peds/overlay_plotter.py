...
plt.savefig('graphs/t1_no_discount/all_traj_overlay.png')
plt.clf()
...
plt.savefig('graphs/t1_w_discount/traj_100/all_traj_overlay.png')
plt.clf()
...
plt.savefig('graphs/t1_no_discount/overlay_w_fade.png')
plt.clf()
...
plt.savefig('graphs/t1_w_discount/traj_100/overlay_w_fade.png')
plt.clf()
