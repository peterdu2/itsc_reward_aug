...
ymin = 999999
for i in range(top_k):
    loaded_data = pickle.load(open('t1_w_discount/traj_050_state_0/pickles/data'+str(i)+'.pkl', "rb" ))
    car_x = loaded_data[1]
    car_y = loaded_data[2]
...
for i in range(top_k):
    ...
    plt.legend(["Car", "Pedestrian 1", "Pedestrian 2", "Pedstrian 3"], loc='upper left')
    plt.title("Discount Factor = 0", y=1.08)
    plt.savefig('graphs/t1_w_discount/traj_050/'+str(i)+'.png')
    plt.clf()
...
for i in range(top_k):
    ...
    plt.legend(["Car", "Pedestrian 1", "Pedestrian 2", "Pedstrian 3"], loc='upper left')
    plt.title("Discount Factor = 0", y=1.08)
    plt.savefig('graphs/t1_w_discount/traj_100/'+str(i)+'.png')
    plt.clf()
...
ymin = 999999
for i in range(top_k):
    loaded_data = pickle.load(open('t1_w_discount/traj_150_state_0/pickles/data'+str(i)+'.pkl', "rb" ))
    car_x = loaded_data[1]
    car_y = loaded_data[2]
    ped1_x = loaded_data[3]
    ped1_y = loaded_data[4]
...
for i in range(top_k):
    ...
    plt.legend(["Car", "Pedestrian 1", "Pedestrian 2", "Pedstrian 3"], loc='upper left')
    plt.title("Discount Factor = 0", y=1.08)
    plt.savefig('graphs/t1_w_discount/traj_150/'+str(i)+'.png')
    plt.clf()
