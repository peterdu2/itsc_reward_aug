...
class MCTS_multi:
	...
	def GeneratePaths(self, starting_state):
		...
		for i in range(self.num_iter):
			...
			# Push initial state
			self.tracker.push_trajectory([copy.deepcopy(self.simulator._peds), copy.deepcopy(self.simulator._car), copy.deepcopy(self.simulator._car2)])
	...
	def Simulate(self, state, depth):
		...
		while depth > 0 and self.model.isEndState(state) != True:
